...
func (c *gameHostClient) JoinLobby(ctx context.Context, in *JoinLobbyRequest, opts ...grpc.CallOption) (GameHost_JoinLobbyClient, error) {
	stream, err := c.cc.NewStream(ctx, &GameHost_ServiceDesc.Streams[0], "/td_game.coopstate.GameHost/JoinLobby", opts...)
	if err != nil {
		return nil, err
	}
	x := &gameHostJoinLobbyClient{stream}
...
func (c *gameHostClient) AwaitGame(ctx context.Context, in *AwaitGameRequest, opts ...grpc.CallOption) (*AwaitGameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/td_game.coopstate.GameHost/AwaitGame", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _GameHost_JoinLobby_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(GameHostServer).JoinLobby(m, &gameHostJoinLobbyServer{stream})
}
...
func _GameHost_AwaitGame_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/td_game.coopstate.GameHost/AwaitGame",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
