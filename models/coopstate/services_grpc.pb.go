...
type GameHostClient interface {
	...
	JoinLobby(ctx context.Context, in *JoinLobbyRequest, opts ...grpc.CallOption) (GameHost_JoinLobbyClient, error)
...
func (c *gameHostClient) FetchLevels(ctx context.Context, in *FetchLevelsRequest, opts ...grpc.CallOption) (*FetchLevelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, GameHost_FetchLevels_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameHostClient) CreateLobby(ctx context.Context, in *CreateLobbyRequest, opts ...grpc.CallOption) (*CreateLobbyResponse, error) {
	...
	err := c.cc.Invoke(ctx, GameHost_CreateLobby_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameHostClient) FetchLobbies(ctx context.Context, in *FetchLobbiesRequest, opts ...grpc.CallOption) (*FetchLobbiesResponse, error) {
	...
	err := c.cc.Invoke(ctx, GameHost_FetchLobbies_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameHostClient) JoinLobby(ctx context.Context, in *JoinLobbyRequest, opts ...grpc.CallOption) (GameHost_JoinLobbyClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &GameHost_ServiceDesc.Streams[0], GameHost_JoinLobby_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &gameHostJoinLobbyClient{ClientStream: stream}
...
type GameHost_JoinLobbyClient interface {
	Recv() (*JoinLobbyResponse, error)
	grpc.ClientStream
}

type gameHostJoinLobbyClient struct {
	grpc.ClientStream
}

func (x *gameHostJoinLobbyClient) Recv() (*JoinLobbyResponse, error) {
	m := new(JoinLobbyResponse)
...
func (c *gameHostClient) PutTower(ctx context.Context, in *PutTowerRequest, opts ...grpc.CallOption) (*PutTowerResponse, error) {
	...
	err := c.cc.Invoke(ctx, GameHost_PutTower_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameHostClient) UpgradeTower(ctx context.Context, in *UpgradeTowerRequest, opts ...grpc.CallOption) (*UpgradeTowerResponse, error) {
	...
	err := c.cc.Invoke(ctx, GameHost_UpgradeTower_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameHostClient) TurnTowerOn(ctx context.Context, in *TurnTowerOnRequest, opts ...grpc.CallOption) (*TurnTowerOnResponse, error) {
	...
	err := c.cc.Invoke(ctx, GameHost_TurnTowerOn_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameHostClient) TurnTowerOff(ctx context.Context, in *TurnTowerOffRequest, opts ...grpc.CallOption) (*TurnTowerOffResponse, error) {
	...
	err := c.cc.Invoke(ctx, GameHost_TurnTowerOff_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameHostClient) ChangeTowerAimType(ctx context.Context, in *ChangeTowerAimTypeRequest, opts ...grpc.CallOption) (*ChangeTowerAimTypeResponse, error) {
	...
	err := c.cc.Invoke(ctx, GameHost_ChangeTowerAimType_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameHostClient) SellTower(ctx context.Context, in *SellTowerRequest, opts ...grpc.CallOption) (*SellTowerResponse, error) {
	...
	err := c.cc.Invoke(ctx, GameHost_SellTower_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameHostClient) StartNewWave(ctx context.Context, in *StartNewWaveRequest, opts ...grpc.CallOption) (*StartNewWaveResponse, error) {
	...
	err := c.cc.Invoke(ctx, GameHost_StartNewWave_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameHostClient) SlowGameDown(ctx context.Context, in *SlowGameDownRequest, opts ...grpc.CallOption) (*SlowGameDownResponse, error) {
	...
	err := c.cc.Invoke(ctx, GameHost_SlowGameDown_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameHostClient) SpeedGameUp(ctx context.Context, in *SpeedGameUpRequest, opts ...grpc.CallOption) (*SpeedGameUpResponse, error) {
	...
	err := c.cc.Invoke(ctx, GameHost_SpeedGameUp_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameHostClient) LeaveLobby(ctx context.Context, in *LeaveLobbyRequest, opts ...grpc.CallOption) (*LeaveLobbyResponse, error) {
	...
	err := c.cc.Invoke(ctx, GameHost_LeaveLobby_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameHostClient) AwaitGame(ctx context.Context, in *AwaitGameRequest, opts ...grpc.CallOption) (*AwaitGameResponse, error) {
	...
	err := c.cc.Invoke(ctx, GameHost_AwaitGame_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameHostClient) SendGameState(ctx context.Context, in *SendGameStateRequest, opts ...grpc.CallOption) (GameHost_SendGameStateClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &GameHost_ServiceDesc.Streams[1], GameHost_SendGameState_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &gameHostSendGameStateClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type GameHostServer interface {
	...
	JoinLobby(*JoinLobbyRequest, GameHost_JoinLobbyServer) error
...
func (UnimplementedGameHostServer) JoinLobby(*JoinLobbyRequest, GameHost_JoinLobbyServer) error {
...
func _GameHost_JoinLobby_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(JoinLobbyRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(GameHostServer).JoinLobby(m, &gameHostJoinLobbyServer{ServerStream: stream})
}

type GameHost_JoinLobbyServer interface {
	Send(*JoinLobbyResponse) error
	grpc.ServerStream
}

type gameHostJoinLobbyServer struct {
	grpc.ServerStream
}

func (x *gameHostJoinLobbyServer) Send(m *JoinLobbyResponse) error {
...
func _GameHost_SendGameState_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(GameHostServer).SendGameState(m, &gameHostSendGameStateServer{ServerStream: stream})
}
